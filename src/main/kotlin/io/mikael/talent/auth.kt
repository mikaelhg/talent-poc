...
class YammerSsoSecurityConfigurer(val beanFactory: BeanFactory) {
    ...
    private fun addAuthenticationEntryPoint(http: HttpSecurity, sso: OAuth2SsoProperties) {
        ...
        exceptions.defaultAuthenticationEntryPointFor(LoginUrlAuthenticationEntryPoint(sso.loginPath), preferredMatcher)
    ...
    internal fun oauth2SsoFilter(sso: OAuth2SsoProperties): OAuth2ClientAuthenticationProcessingFilter {
